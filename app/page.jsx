...
export default function Home() {
  return (
    <div className="mt-28">
      ...
      <section className="py-20 bg-green-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-1b">
            How It Works
          </h2>
      ...
      <section className="py-20 bg-green-400">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-green-50 mb-8 max-w-2xl mx-auto text-xl">
            Join thousands of users who are already managning their finances
            smarter with Expensia
          </p>
